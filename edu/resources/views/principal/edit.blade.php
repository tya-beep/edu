...
<div class="ui-page-shell" style="max-width:1200px;margin:0 auto;">
    ...
    <div class="ui-page-heading">
        <div class="ui-page-heading__copy">
            <h1 style="display:flex;align-items:center;gap:10px;">
                <i class="fas fa-edit" style="color:var(--app-primary);font-size:24px;"></i> Edit Principal Profile
            </h1>
            <p>ID: <strong>{{ $principal->principalID }}</strong></p>
        </div>
    ...
    <div class="ui-card ui-card--section" style="position:relative;overflow:hidden;">
        ...
        <div class="ui-card__body" style="padding:28px;position:relative;z-index:1;">
            <form action="{{ route('principals.update', $principal->principalID) }}" method="POST" id="principalForm">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <div class="ui-field">
                            <label class="ui-label"><i class="fas fa-id-card"></i> Principal ID (Read-only)</label>
                            <input type="text" class="ui-input" value="{{ $principal->principalID }}" readonly style="background:var(--app-divider);color:var(--app-text-secondary);cursor:not-allowed;">
                            <input type="hidden" name="principalID" value="{{ $principal->principalID }}">
                            <div class="ui-field__helper">Principal ID cannot be changed</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="ui-field">
                            ...
                            <input type="text" 
                                   name="principalName"
                                   class="ui-input"
                                   value="{{ old('principalName', $principal->principalName) }}" 
                                   required
                    ...
                    <div class="col-md-6">
                        <div class="ui-field">
                            ...
                            <input type="text" 
                                   name="ICNumber"
                                   class="ui-input"
                                   value="{{ old('ICNumber', $principal->ICNumber) }}" 
                                   required
                    ...
                    <div class="col-md-6">
                        <div class="ui-field">
                            ...
                            <select name="status" class="ui-select">
                                <option value="Aktif" {{ (old('status', $principal->status ?? 'Aktif') == 'Aktif') ? 'selected' : '' }}>
                                    ✅ Active
                                </option>
                                <option value="Berhenti" {{ (old('status', $principal->status ?? 'Aktif') == 'Berhenti') ? 'selected' : '' }}>
                                    ⏹️ Stopped / Resigned
                                </option>
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="ui-field">
                            ...
                            <select name="maritalStatus" class="ui-select">
                                ...
                                <option value="Single" {{ old('maritalStatus', $principal->maritalStatus) == 'Single' ? 'selected' : '' }}>💑 Single</option>
                                <option value="Married" {{ old('maritalStatus', $principal->maritalStatus) == 'Married' ? 'selected' : '' }}>💒 Married</option>
                                <option value="Divorced" {{ old('maritalStatus', $principal->maritalStatus) == 'Divorced' ? 'selected' : '' }}>💔 Divorced</option>
                                <option value="Widowed" {{ old('maritalStatus', $principal->maritalStatus) == 'Widowed' ? 'selected' : '' }}>🕊️ Widowed</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="ui-field">
                            ...
                            <select name="race" class="ui-select">
                                ...
                                <option value="Malay" {{ old('race', $principal->race) == 'Malay' ? 'selected' : '' }}>Malay</option>
                                <option value="Chinese" {{ old('race', $principal->race) == 'Chinese' ? 'selected' : '' }}>Chinese</option>
                                <option value="Indian" {{ old('race', $principal->race) == 'Indian' ? 'selected' : '' }}>Indian</option>
                                <option value="Others" {{ old('race', $principal->race) == 'Others' ? 'selected' : '' }}>Others</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="ui-field">
                            ...
                            <input type="number" 
                                   name="latestAge" 
                                   class="ui-input" 
                                   value="{{ old('latestAge', $principal->latestAge) }}"
                                   min="0"
                                   max="120"
                    ...
                    <div class="col-md-6">
                        <div class="ui-field">
                            ...
                            <input type="text" 
                                   name="phoneNumber"
                                   class="ui-input"
                                   value="{{ old('phoneNumber', $principal->phoneNumber) }}"
                    ...
                    <div class="col-md-6">
                        <div class="ui-field">
                            ...
                            <input type="email" 
                                   ...
                                   placeholder="principal@school.edu.my">
                    ...
                    <div class="col-12">
                        <div class="ui-field">
                            ...
                            <textarea name="address" 
                                      class="ui-textarea" 
                                      rows="3"
                                      placeholder="Enter full address (Street, City, State, Postal Code)">{{ old('address', $principal->address) }}</textarea>
                            ...
                            <select name="schoolID" class="ui-select" required>
                                ...
                                @foreach($schools as $school)
                                    <option value="{{ $school->schoolID }}" 
                                        {{ old('schoolID', $principal->schoolID) == $school->schoolID ? 'selected' : '' }}>
                                        {{ $school->schoolName }} ({{ $school->schoolID }})
                                    </option>
                                @endforeach
                            </select>
                            <div class="ui-field__helper">Select the school this principal manages</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="ui-field">
                            ...
                            <input type="date" 
                                   name="appointedDate" 
                                   class="ui-input" 
                                   value="{{ old('appointedDate', $principal->appointedDate) }}">
                            <div class="ui-field__helper">Date when appointed as principal</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="ui-field">
                            ...
                            <input type="number" 
                                   name="serviceDate" 
                                   class="ui-input" 
                                   value="{{ old('serviceDate', $principal->serviceDate) }}"
                                   min="0"
                                   step="1"
                    ...
                    <div class="col-md-4">
                        <div class="ui-field">
                            ...
                            <input type="date" 
                                   name="pensionDate" 
                                   class="ui-input" 
                                   value="{{ old('pensionDate', $principal->pensionDate) }}">
                ...
                <div style="display:flex;gap:12px;flex-wrap:wrap;">
                    ...
                    <a href="{{ route('principals.show', $principal->principalID) }}" class="ui-button ui-button--compact" style="min-height:44px;padding:0 24px;display:inline-flex;align-items:center;gap:8px;">
...
<script>
    ...
    const inputs = document.querySelectorAll('#principalForm input, #principalForm select, #principalForm textarea');

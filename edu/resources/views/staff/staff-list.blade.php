...
<div class="ui-page-shell">
    ...
    <div class="ui-page-heading">
        <div class="ui-page-heading__copy">
            <h1 style="display:flex;align-items:center;gap:10px;">
                <i class="fas fa-users" style="color:var(--app-primary);font-size:24px;"></i> Staff List
            </h1>
            <p>Manage all registered staff members</p>
        </div>
        <div class="ui-page-heading__actions">
            <span class="ui-badge ui-badge--info">
                <i class="fas fa-user"></i> {{ isset($staffs) ? $staffs->count() : 0 }} Staff
            </span>
            ...
            <a href="{{ route('staff.template') }}" class="ui-button ui-button--compact" style="min-height:36px;padding:0 16px;display:inline-flex;align-items:center;gap:6px;font-size:13px;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:12px;margin-bottom:20px;align-items:center;justify-content:space-between;">
        <form method="GET" style="display:flex;gap:10px;flex-wrap:wrap;flex:1;">
            ...
            @if(request('search'))
                <a href="{{ route('staff.list') }}" class="ui-button ui-button--compact" style="height:40px;padding:0 16px;">
    ...
    @if(isset($staffs) && count($staffs) > 0)
        @foreach($staffs as $department => $group)
            <div style="margin-bottom:24px;">
                ...
                <div style="background:linear-gradient(135deg, #1e3a5f, #1e40af);color:#fff;padding:12px 20px;border-radius:var(--app-radius-card) var(--app-radius-card) 0 0;font-weight:700;font-size:14px;display:flex;align-items:center;gap:10px;">
                    ...
                    <span class="ui-badge" style="background:rgba(255,255,255,0.2);border-color:rgba(255,255,255,0.3);color:#fff;font-size:11px;padding:2px 12px;margin-left:auto;">
                        <i class="fas fa-user"></i> {{ $group->count() }} Staff
                    </span>
                </div>
                        ...
                        <div class="ui-table-wrap">
                            <table class="ui-table ui-table--dashboard">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        $currentStatus = strtolower($staff->status ?? 'active');
                                        $isActive = in_array($currentStatus, ['active', 'aktif']);
                                    @endphp
                                    <tr>
                                        <td>
    ...
    @else
        <div class="ui-state ui-state--compact">
            ...
            <div class="ui-state__title">No Staff Found</div>
            ...
            @if(request('search'))
                <a href="{{ route('staff.list') }}" class="ui-button ui-button--primary" style="margin-top:16px;">
...
<div id="registerModal" class="modal" style="display:none;">
    <div class="modal-box">
        <div class="modal-header" style="display:flex;justify-content:space-between;align-items:center;">
            <div class="modal-title">Register New Staff</div>
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('staff.store') }}">
                ...
                <input name="staffID" placeholder="Staff ID" class="form-control-custom" required>
                <input name="staffName" placeholder="Staff Name" class="form-control-custom" required>
                ...
                <div class="form-row">
                    ...
                    <input type="date" name="serviceDate" class="form-control-custom">
                </div>
                <div class="form-row">
                ...
                <div class="modal-actions">
                    <button type="submit" class="btn-custom">💾 Save Staff</button>
...
<div id="csvModal" class="modal" style="display:none;">
    <div class="modal-box">
        <div class="modal-header" style="display:flex;justify-content:space-between;align-items:center;">
            <div class="modal-title">Import Staff CSV</div>

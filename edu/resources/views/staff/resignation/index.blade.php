                ...
                <div class="status-card-body">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <div class="info-value-large">{{ $staff->resignation_request_date }}</div>
                            </div>
                        </div>
                        <div class="info-item">
                            <div class="info-icon-sm">
                            ...
                            <div>
                                ...
                                <div class="info-value-large">
                                    {{ \Carbon\Carbon::parse($staff->resignation_request_date)->diffInDays(now()) }} days
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="reason-box">
                        ...
                        <div class="reason-text">
                            {{ $staff->resignation_request_reason }}
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('staff.resignations.cancel') }}" 
                ...
                <div class="status-card-body">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div>
                                <div class="info-label">Resignation Date</div>
                                <div class="info-value">{{ $staff->resignation_request_date }}</div>
                            </div>
                        </div>
                        <div class="info-item">
                            <div class="info-icon-sm">
                            ...
                            <div>
                                ...
                                <div class="info-value">{{ $staff->resignation_effective_date ?? $staff->pensionDate ?? 'Not set' }}</div>
                            </div>
                        </div>
                        <div class="info-item">
                            <div class="info-icon-sm">
                            ...
                            <div>
                                ...
                                <div class="info-value">
                                    @if($staff->resignation_effective_date)
                                        {{ \Carbon\Carbon::now()->diffInDays($staff->resignation_effective_date) }} days
                                    @else
                                        Not specified
                                    @endif
                                </div>
                    ...
                    @if($staff->resignation_effective_date)
                        <div class="days-counter">
                            ...
                            @php
                                $daysLeft = \Carbon\Carbon::now()->diffInDays($staff->resignation_effective_date);
                            @endphp
                            @if($daysLeft <= 30)
                                <span>⚠️ Only {{ $daysLeft }} days remaining until your last working day</span>
                            @else
                                <span>{{ $daysLeft }} days remaining until your last working day</span>
                            @endif
                        </div>
                    @endif
                    ...
                    <div class="note-box" style="background: #d1fae5; border-left-color: #10b981;">
                        ...
                        <div class="note-content" style="color: #065f46;">
                            <strong>Your resignation has been approved.</strong> 
                            @if($staff->resignation_effective_date)
                                Your last working day will be <strong>{{ $staff->resignation_effective_date }}</strong>.
                            @endif
                            Please complete all necessary handover procedures.
                        </div>
                    </div>
                </div>
            </div>
        ...
        @elseif($staff->resignation_request_status == 'rejected')
            ...
            <div class="status-card status-rejected">
                ...
                <div class="status-card-body">
                    ...
                    <a href="{{ route('staff.resignations.create') }}" class="btn-submit">

    ...
    <div class="form-container">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div>
                        ...
                        <div class="info-value">{{ $teacher->teacherName }}</div>
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-icon">
                    ...
                    <div>
                        ...
                        <div class="info-value">{{ $teacher->schoolID }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="warning-card">
            ...
            <div class="warning-content">
                ...
                <ul>
                    <li>Please ensure you have read your employment contract regarding notice period</li>
                    <li>Your resignation will be reviewed by HR within 7 working days</li>
                    <li>Once approved, you will be retired on your last working day</li>
                    <li>You may cancel your application before HR reviews it</li>
                </ul>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form method="POST" action="{{ route('teacher.resignations.store') }}">
                    @csrf
                    ...
                    <div class="d-flex gap-3 justify-content-end">
                        <a href="{{ route('teacher.resignations.index') }}" class="btn-cancel">
        ...
        {{-- Process Steps --}}
        <div class="info-card" style="margin-top: 1.5rem; background: var(--gray-50);">
            <div class="info-title">

...
<div class="ui-page-shell" style="max-width:1000px;margin:0 auto;">
    ...
    <div class="ui-page-heading">
        ...
        <div class="ui-page-heading__actions">
            ...
            <span class="ui-badge ui-badge--info">
                <i class="fas fa-id-card"></i> {{ $selfInfo['teacherID'] ?? '—' }}
            </span>
        </div>
    </div>
    ...
    <div class="ui-card ui-card--section" style="position:relative;overflow:hidden;">
        ...
        {{-- Profile Header --}}
        <div class="ui-card__header" style="background:linear-gradient(135deg, #0f2e1f 0%, #1a4732 40%, #1e5a3a 100%);border-radius:18px 18px 0 0;margin:-1px -1px 0 -1px;padding:28px 32px;position:relative;z-index:1;">
            ...
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['teacherName'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        <span style="font-size:13px;font-weight:500;color:var(--app-text-subtle);display:flex;align-items:center;gap:6px;">
                            <i class="fas fa-id-card" style="color:var(--app-primary);font-size:12px;"></i> Teacher ID
                        </span>
                        <span style="font-size:14px;font-weight:700;color:var(--app-primary);">{{ $selfInfo['teacherID'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['ICNumber'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['gender'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['race'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['maritalStatus'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['email'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $selfInfo['phoneNumber'] ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                    ...
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">
                            ...
                            @if($serviceYearsFromDb !== null && $serviceYearsFromDb > 0)
                                <strong style="color:var(--app-primary);">{{ $serviceYearsFromDb }}</strong> year{{ $serviceYearsFromDb > 1 ? 's' : '' }}
                            @elseif($serviceYears && $serviceYears > 0)
                                <strong style="color:var(--app-primary);">{{ $serviceYears }}</strong> year{{ $serviceYears > 1 ? 's' : '' }}
                            @else
                                <span style="color:var(--app-text-subtle);font-weight:400;font-style:italic;font-size:13px;">—</span>
                            @endif
                        </span>
            ...
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:700;color:var(--app-text);">{{ $schoolName ?? '—' }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        <span style="font-size:13px;font-weight:500;color:var(--app-text-subtle);display:flex;align-items:center;gap:6px;">
                            <i class="fas fa-id-card" style="color:var(--app-primary);font-size:12px;"></i> School ID
                        </span>
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $schoolID ?? '—' }}</span>
                    </div>
                </div>
                @if($schoolAddress)
                <div class="col-12">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        <span style="font-size:13px;font-weight:500;color:var(--app-text-subtle);display:flex;align-items:center;gap:6px;">
                            <i class="fas fa-map-marker-alt" style="color:var(--app-primary);font-size:12px;"></i> Address
                        </span>
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $schoolAddress }}</span>
                    </div>
                </div>
                @endif
                @if($schoolPhone)
                <div class="col-md-6">
                    <div class="info-item" style="display:flex;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--app-divider);">
                        ...
                        <span style="font-size:14px;font-weight:600;color:var(--app-text);">{{ $schoolPhone }}</span>
                    </div>
                </div>
                @endif
            </div>

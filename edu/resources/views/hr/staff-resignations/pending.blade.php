...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <h2 class="page-title">Pending Staff Resignation Requests</h2>
    ...
    <div class="card main-card shadow-sm">
        <div class="card-header-custom">
            <h5>
                <i class="fas fa-clock"></i> Staff Resignation Requests Awaiting Review
            </h5>
            <span class="pending-badge">
                <i class="fas fa-hourglass-half"></i> {{ isset($staff) ? $staff->count() : 0 }} Pending
            </span>
        </div>
        <div class="card-body p-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="reason-cell">
                                    <div class="text-truncate" style="max-width: 200px;" title="{{ $staffMember->resignation_request_reason }}">
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>All staff resignation requests have been reviewed. Great job!</p>
                </div>
            @endif
        </div>
    </div>
    ...
    {{-- Back Button --}}
    <div class="mt-3">
        <a href="{{ route('hr.staff-resignations.all') }}" class="btn-back">

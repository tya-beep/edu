...
@section('title', 'Review Staff Resignation')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <h2 class="page-title">Review Staff Resignation</h2>
            ...
            <div class="card profile-card mb-4">
                <div class="card-header-custom" style="background: linear-gradient(135deg, var(--gray-50), white);">
                    ...
                    <span class="badge-status 
                        @if($staff->resignation_request_status == 'pending') badge-pending
                        @elseif($staff->resignation_request_status == 'approved') badge-approved
                        @elseif($staff->resignation_request_status == 'rejected') badge-rejected
                        @else badge-unknown @endif">
                        @if($staff->resignation_request_status == 'pending')
                            ⏳ Pending
                        @elseif($staff->resignation_request_status == 'approved')
                            ✅ Approved
                        @elseif($staff->resignation_request_status == 'rejected')
                            ❌ Rejected
                        @else
                            {{ $staff->resignation_request_status ?? 'Unknown' }}
                        @endif
                    </span>
                </div>
                <div class="card-body-custom">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="value"><code>{{ $staff->staffID }}</code></div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="value">{{ $staff->ICNumber }}</div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="value">{{ $staff->phoneNumber ?? '-' }}</div>
                        </div>
                        <div class="info-item">
                ...
                <div class="card-body-custom">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="value">
                                {{ isset($staff->resignation_request_date) ? \Carbon\Carbon::parse($staff->resignation_request_date)->format('d/m/Y h:i A') : 'N/A' }}
                            </div>
                        </div>
                        <div class="info-item">
                            ...
                            <div class="value">
                                ...
                                @else
                                    <span class="badge badge-unknown">{{ $staff->resignation_request_status ?? 'Unknown' }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="info-item" style="grid-column: 1 / -1;">
                            ...
                            <div class="reason-box" style="margin-top: 0.5rem; border-left-color: #f59e0b;">
                                <div class="text">
                                    {{ $staff->resignation_request_reason ?? 'No reason provided' }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('hr.staff-resignations.approve', $staff->staffID) }}">
                                    @csrf
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Staff will be retired on this date</small>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">
                                    ...
                                    <button type="submit" class="btn-approve" onclick="return confirm('Are you sure you want to approve this resignation for {{ $staff->staffName }}?')">
                    ...
                    <div class="col-md-6">
                        <div class="form-card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('hr.staff-resignations.reject', $staff->staffID) }}">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label">
                                    ...
                                    <button type="submit" class="btn-reject" onclick="return confirm('Are you sure you want to reject this resignation for {{ $staff->staffName }}?')">
                    ...
                    <div class="card-body-custom">
                        <div class="info-alert">
                            ...
                            <div>
                                ...
                                <strong>{{ ucfirst($staff->resignation_request_status) }}</strong>.
                                @if($staff->resignation_remarks)
                                    <br><strong>Remarks:</strong> {{ $staff->resignation_remarks }}
                                @endif
                                @if($staff->resignation_approved_date)
                                    <br><strong>Effective Date:</strong> 
                                    {{ \Carbon\Carbon::parse($staff->resignation_approved_date)->format('d/m/Y') }}
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            {{-- Back Button --}}
            <div class="mt-4">
                <a href="{{ route('hr.staff-resignations.pending') }}" class="btn-back">

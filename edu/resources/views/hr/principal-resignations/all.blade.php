...
@section('title', 'All Principal Resignations')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <h2 class="page-title">All Principal Resignation Requests</h2>
    ...
    @php
        ...
        $pending = $principals->where('resignation_request_status', 'pending')->count();
        $approved = $principals->where('resignation_request_status', 'approved')->count();
        $rejected = $principals->where('resignation_request_status', 'rejected')->count();
    @endphp
    ...
    <div class="card main-card shadow-sm">
        <div class="card-header-custom">
            <h5>
                <i class="fas fa-list-ul"></i> Principal Resignation History
            </h5>
            <div class="text-muted small">
        ...
        <div class="card-body p-0">
                    ...
                    <table class="table resignation-table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($principal->pensionDate)
                                        <i class="fas fa-hourglass-end text-muted me-1"></i>
                                        {{ \Carbon\Carbon::parse($principal->pensionDate)->format('d/m/Y') }}
                                    @else
                                        -
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    {{ isset($principal->created_at) ? \Carbon\Carbon::parse($principal->created_at)->format('d/m/Y') : '-' }}
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            @else
                <div class="empty-state">
                    ...
                    <h5>No Principal Resignation Requests</h5>
                    <p>No principal resignation requests found in the system.</p>
                </div>
            @endif
        </div>
    </div>
    ...
    {{-- Action Buttons --}}
    <div class="mt-3">
        <a href="{{ route('hr.principal-resignations.pending') }}" class="btn-pending">
